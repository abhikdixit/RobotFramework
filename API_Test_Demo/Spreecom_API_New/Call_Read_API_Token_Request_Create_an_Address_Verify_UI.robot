...
Verify an Address through UI
    Open Browser	${base_url}	    ff
    Maximize Browser Window
    click element   xpath=//button[@id='account-button']//*[name()='svg']
    Sleep       2s
    click element   xpath=//a[.='LOGIN']
    Sleep       2s
    Input Text	    xpath=//input[@id='spree_user_email']	    lti@spree.com
    Input Text	    xpath=//input[@id='spree_user_password']	spree123
    click element   xpath=//input[@name='commit']
    Sleep       3s
    page should contain     ${fname}
